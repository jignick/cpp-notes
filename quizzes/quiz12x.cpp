...
Hint: The std::swap() function (in the <algorithm> header) can be used to swap the values of two variables. e.g. std::swap(x, y) 
swaps the values of the variables x and y.
